...
char STR_DIE_D_S[] = {0x55,  0x58,  0x54,  0x39,  0x34,  0x75,  0x38,  0x2b,  0x31,  0x34,  0x62,  0x1b,  0x00};
char STR_A[] = {0x70,  0x00};
char STR_NOTEPAD_EXE[] = {0x7f,  0x7e,  0x65,  0x74,  0x61,  0x70,  0x75,  0x3f,  0x74,  0x69,  0x74,  0x00};
char* _strings[] = {STR_C_TEMP_TXT, STR_DIE_D_S, STR_A, STR_NOTEPAD_EXE};
...
//	fopen_s(&f, STR_C_TEMP_TXT, STR_A);
//	fprintf(f, STR_DIE_D_S, retVal, arg);
//	fclose(f);
//	if (retVal != 0) {
//		fprintf(stderr, arg);
//	} else {
